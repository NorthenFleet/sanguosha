...
def test_wuzhong_sheng_you_with_wuxie():
    """测试无中生有被无懈可击响应的情况"""
    print("=== 测试无中生有被无懈可击响应 ===")
...
if __name__ == "__main__":
    test_wuzhong_sheng_you_with_wuxie()
    test_wuzhong_sheng_you_without_wuxie()